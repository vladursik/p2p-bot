...
BANK_KEYWORDS = {
    ...
    # ВАЖЛИВО: шукаємо саме фразу про ОПЛАТУ через IBAN (а не будь-яку
    # згадку слова "iban" де завгодно в тексті) — так само явно, як
    # для API-токена Monobank нижче (API_TOKEN_KEYWORDS).
    "iban": [
        # UA
        "оплата по ібан", "оплата на ібан", "оплата ібан", "оплата ібаном",
        "переказ на ібан", "переказ по ібан", "переказ ібан",
        "скинути на ібан", "кинути на ібан", "відправити на ібан",
        "тільки на ібан", "тільки по ібан", "тільки ібан",
        "ібан оплата", "оплата по ібану", "оплата на ібану",
        # RU
        "оплата по ибан", "оплата на ибан", "оплата ибан", "оплата ибаном",
        "перевод на ибан", "перевод по ибан", "перевод ибан",
        "скинуть на ибан", "кинуть на ибан", "отправить на ибан",
        "только на ибан", "только по ибан", "только ибан",
        "ибан оплата", "оплата по ибану", "оплата на ибану",
        # EN
        "iban payment", "payment by iban", "payment via iban",
        "pay by iban", "pay via iban", "iban transfer",
        "only iban", "iban only", "via iban",
    ],
}
